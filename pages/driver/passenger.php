...
<main class='passOverview'>
    <div class='row image'>
        <div class='center z-depth-1'>
            ...
            <p class='name'><?php echo $name;?><input type="hidden" class='passenger_id' value='<?php echo $user_id;?>'><input type="hidden" class="driver_id" value="<?php echo $_SESSION['user']['id'];?>">
